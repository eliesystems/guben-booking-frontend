<template>
  <v-container>
    <v-form ref="form" v-model="valid">
      ...
      <v-row>
        <v-col class="">
          <v-card v-if="!!selectedTenant.genericMailTemplate" flat height="100">
            <v-snackbar
              :timeout="-1"
              :value="true"
              absolute
            ...
            >
              ...
              Es ist eine E-Mail-Vorlage hinterlegt. Um diese zu ändern, wenden
          ...
          <v-card v-else flat height="100">
            <v-snackbar :timeout="-1" :value="true" absolute color="error" text>
              ...
              Es ist keine E-Mail-Vorlage hinterlegt. Um eine E-Mail-Vorlage zu
              hinterlegen, wenden Sie sich bitte an den Administrator.
            </v-snackbar>
          </v-card>
        </v-col>
      </v-row>
